...
- [roboflow/multimodal-maestro](https://github.com/roboflow/multimodal-maestro) - streamline the fine-tuning process for multimodal models: PaliGemma, Florence-2, and Qwen2-VL
