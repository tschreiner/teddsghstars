...
- [allmonday/pydantic-resolve](https://github.com/allmonday/pydantic-resolve) - a business model friendly data orchestration tool, provide a simple way to implement the core concept of clean architecture.
